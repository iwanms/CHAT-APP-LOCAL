...
const Sidebar = () => {
  ...
  // Efek untuk memicu re-render ketika unreadCounts berubah
  // useEffect(() => {
  //   setForceRender((prev) => !prev); // Toggle state untuk memaksa re-render
  // }, [unreadCounts]);
  ...
  useEffect(() => {
    const unsubscribe = useChatStore.subscribe(
      ...
      (unreadCounts) => {
        // This will trigger whenever unreadCounts changes
